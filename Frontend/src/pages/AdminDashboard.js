      ...
      <div className="row g-3">
        ...
        <div className="col-lg-6">
          <div className="card h-100"><div className="card-body">
            ...
            <div className="table-responsive" style={{maxHeight: 260}}>
              <table className="table table-sm table-striped"><thead><tr><th>ID</th><th>Pickup</th><th>Dropoff</th><th>Total</th><th>Status</th></tr></thead>
                <tbody>
                  {reservations.map(r => (
                    <tr key={r.reservationId}>
                      <td>{r.reservationId}</td><td>{r.pickupDate}</td><td>{r.dropoffDate}</td><td>{r.totalAmount}</td><td>{r.status}</td>
                    </tr>
                  ))}
